...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">DEE&HEMA HOTEL.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 20002 20002</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">H D <span>HOTEL</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">HD HOTEL</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our HD HOTEL</h3> 
						   <p class="about-para-w3ls">HD HOTELS ARE OTHER NAMES FOR COMFORT.<br> NEVER TAKE A SECOND CHANCE TO CHOOSE THE BEST </p>
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
										<div class="w3l-slider-img">
											<img src="images/a1.jpg" class="img-responsive" alt="Hair Salon">
										</div>
                                       <div class="w3ls-info-about">
										    <h4>You'll love all the amenities we offer! EXCLUSIVE FOR YOU ...</h4>
											<p>CHATCH THE BEST HOTEL WITH BEST ROOM WITH ALL EMOTIONS  </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
			 ...
			 <div class="col-md-6 advantage-grid left-w3ls wow bounceInLeft" data-wow-delay="0.3s">
			 	<div class="advantage-block ">
					<i class="fa fa-credit-card" aria-hidden="true"></i>
			 		...
			 		<p>YOU HAVE ALL RIGHTS TO ASK FOR WHAT YOU WANT </p>
			 ...
			 <div class="col-md-6 advantage-grid right-w3ls wow zoomIn" data-wow-delay="0.3s">
			 	<div class="advantage-block">
					<i class="fa fa-clock-o" aria-hidden="true"></i>
			 		...
			 		<p>TASTE THE BEST OF INDIA<br> ALL THE TASTES OF WORLD ARE AVAIALABLE </p>
			...
			<div id="horizontalTab">
					...
					<div class="col-md-6 team-img-w3-agile">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>JOE</h4>
							<span>9658</span>
							<p>THE CO-FOUNDER AND MANAGING DIRECTOR</p>	
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
								<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
					...
					<ul class="slides">
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>NEVER MISS THE A CHANCE TO STAY IN HD HOTEL </p>
								<h5>HARSHITHA GH</h5>
								<p>Germany</p>
							</div>
							<div class="clearfix"> </div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 20002 20002</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">dee&hema hotel.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> MG ROAD HASSAN ,karnataka</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 15 feb 2024 . all rights reserved | Design by <a href="index.php">HD HOTEL</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
